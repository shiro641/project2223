...
def get_data(input_path):
    ...
    for data_path in data_paths:
        ...
        for annot in annots:
            ...
            if element_filename[0:6] == 'screen':
                p1 = r".png"
                element_filename = re.sub(p1, ".jpg", element_filename)
            ...
            if len(element_objs) > 0:
                annotation_data = {'filepath': os.path.join(imgs_path, element_filename), 'width': element_width,
                                   'height': element_height, 'bboxes': [], 'image_id': idx}
            ...
            for element_obj in element_objs:
                ...
                if class_name == 'tomato soup' or class_name == 'te' or class_name == 'e' or class_name == 'dog':
                    class_name = 'text'
                elif class_name == 'im':
                    class_name = 'image'
                elif class_name == 'link\\':
                    class_name = 'link'
                elif class_name == 'bg' or class_name == 'b':
                    class_name = 'button'
