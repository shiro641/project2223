...
parser.add_option("--num_epochs", dest="num_epochs", help="Number of epochs.", default=1000)
parser.add_option("--config_filename", dest="config_filename",
                  help="Location to store all the metadata related to the training (to be used when testing).",
                  default="config.pickle")
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='c')
    ...
    while True:
        ...
        if iter_num == epoch_length:
            ...
            if C.verbose:
                ...
                print('current loss is: {}'.format(loss_rpn_cls + loss_rpn_regr + loss_class_cls + loss_class_regr))
